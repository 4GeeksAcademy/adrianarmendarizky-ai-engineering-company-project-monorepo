// lib/auth.ts
//
// Reads and checks the session token. Incidents never sets one itself
...
// current URL rather than hardcoded or configured separately. Two
// cases:
//  - Plain localhost dev: swap this app's port for 3000.
//  - GitHub Codespaces forwarded URLs, shaped like
//    "<codespace-name>-<port>.app.github.dev": swap the trailing
//    "-<port>" segment. A hardcoded "localhost:3000" would silently
//    point at your own machine instead of the Codespace when you're
//    on a forwarded preview URL -- this handles both correctly.
